<template>
	 <div v-if="show" class="recharge">
	    ...
	    <form :action="recharge.gateWayUrl" method="post" ref="rechargeForm"  >
	    	<input type="text" name="mchnt_cd" :value="recharge.mchnt_cd" />
	    	<input type="text" name="order_id" :value="recharge.order_id" />
	    	<input type="text" name="order_amt" :value="recharge.order_amt" />
	    	<input type="text" name="order_pay_type" :value="recharge.order_pay_type" />
	    	<input type="text" name="page_notify_url" :value="recharge.page_notify_url" />
	    	<input type="text" name="back_notify_url" :value="recharge.back_notify_url" />
	    	<input type="text" name="iss_ins_cd" :value="recharge.iss_ins_cd" />
	    	<input type="text" name="ver" :value="recharge.ver" />
	    	<input type="text" name="md5" :value="recharge.md5" />
...
export default {
	...
	computed: {
		show () {
			return this.$store.state.enterpriseRecharge.show
		},
		recharge () {
			return this.$store.state.enterpriseRecharge.recharge
		}
	},
	watch: {
		recharge () {
            ...
            this.$refs[name].validate((valid) => {
                if (valid) {
                    if (this.bankCode === '') {
                    	...
                    	this.$store.dispatch('enterpriseRecharge', obj)
	...
	created () {
		...
		if (account) {
			this.$store.dispatch('enterpriseRechargeConfirm', { account })
		} else {
