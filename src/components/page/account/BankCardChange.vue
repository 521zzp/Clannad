...
export default {
    ...
    created () {
    	...
    	this.$store.dispatch('accountBankDetailInfoGet')
    },
    computed: {
    	bankList () {
    	...
    	details () {
    		return this.$store.state.account.bankDetailInfo
    	}
    },
    watch: {
    	details () {
			const { name, idcard, bank, area, branch,  subbranch, card, phone } = this.details
    		this.form = {
    			name: name,
                idcard: idcard,
                bank: bank.toString(),
        ...
        handleSubmit (name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                	...
                	this.$store.dispatch('accountBankChange', obj)
                }
            })
        },
        handleReset (name) {
            ...
            this.form.idcard = this.details.idcard
        }
    }
}
</script>
